...
## Conventions
- Every content-model change goes through `tina/config.ts`; dev or build regenerates the client and types before code uses them. Skill: `/tinacms-schema` or `$tinacms-schema`.
